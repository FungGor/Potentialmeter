...
#define MAX_APPLICATION_SPEED_RPM       18000 /*!< rpm, mechanical */
...
#define PID_SPEED_KI_DEFAULT          600/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE3_FINAL_SPEED_UNIT         (133*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           12032
/* Phase 4 */
#define PHASE4_DURATION                2900 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (4000*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           12032
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (4000*SPEED_UNIT/_RPM)
